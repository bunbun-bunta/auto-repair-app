...
exports.loadEnvironmentConfig = exports.getElectronPaths = exports.AppConfig = void 0;
...
const getElectronPaths = () => {
    try {
        ...
        if (app && app.isReady()) {
            return {
                ...
                LOGS: path_1.default.join(app.getPath('logs'), 'auto-repair-app'),
            };
        }
    }
    catch (error) {
    ...
    return exports.AppConfig.PATHS;
};
exports.getElectronPaths = getElectronPaths;
// 環境変数から設定を読み込む関数
